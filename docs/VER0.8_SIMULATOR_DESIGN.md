...
V3d status is `APPROVED`. Phase 4C-2d3b1i6a status is `APPROVED`; implementation authorization is
`APPROVED_FOR_NEXT_PHASE`. The next implementation candidate is Phase 4C-2d3b1i6b1 — Historical input
snapshot domain implementation. This final approval records the authoritative V3a/V3b/V3c/V3d contract but
does not begin 1i6b1.
