...
At this C4j1 review-candidate stage, release documentation is prepared on a review
branch. Master integration is pending. The `v0.8.0` tag has not been created, and a
GitHub Release has not been published. Final integration, annotated tagging, release
date, and publication require separate independent approval.
