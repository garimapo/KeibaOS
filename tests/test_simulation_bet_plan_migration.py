...
class SimulationBetPlanMigrationTests(unittest.TestCase):
    ...
    def test_v009_is_registered_after_v008_without_duplicate_version(self) -> None:
        self.assertEqual(tuple(migration.VERSION for migration in MIGRATIONS), (8, 9, 10, 11, 12, 13, 14, 15))
        ...
        self.assertEqual(sum(migration.VERSION == 14 for migration in MIGRATIONS), 1)
